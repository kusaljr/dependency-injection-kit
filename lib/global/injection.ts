...
// Generated on: 2025-06-18T10:41:34.707Z

import * as module0 from '../../src/gateways/socket.gateway';
import * as module1 from '../../src/modules/products/product.controller';
import * as module2 from '../../src/modules/user/user.controller';
import * as module3 from '../../src/modules/user/user.interceptors';
import * as module4 from '../../src/modules/user/user.service';
